...
class GetEventsPaginationTest extends Simulation {
 ...
 val baseHttpProtocol =
  ...
  val locationId = "b6a89e45-6778-4a81-a35b-6bd09a1514de"
  ...
  val scn = scenario("get-events-pagination-scenario")
   .exec(
     http("Free busy")
       .get(s"api/public/clients/$clientId/events?&offset=0&limit=9&locationId=$locationId&startDate=$startISOString&endDate=$endISOString&numberOfParticipants=1")
